...
> **Note:** This guide is for developers comfortable with a terminal. If you're not a developer, use the [Desktop App installation guide](installation.md) instead — it covers the full setup without any of this.
